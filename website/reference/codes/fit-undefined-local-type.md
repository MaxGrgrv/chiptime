---
description: "FIT_UNDEFINED_LOCAL_TYPE: A data message references a local type with no definition. — what this chiptime error code means and how to handle it."
---
...
**A data message references a local type with no definition.**
...
for d in [*result.errors, *result.warnings, *result.provenance]:
    if d.code == "FIT_UNDEFINED_LOCAL_TYPE":
        print(d.code, "-", d.detail)
```

All codes are stable machine contract — grep logs for the string `FIT_UNDEFINED_LOCAL_TYPE`,
