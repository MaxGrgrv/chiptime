...
INVOCATIONS = [
    ...
    ["edit", "{file}", "-o", "{out}"],
    ["trim", "{file}", "-o", "{out}", "--after", "+5s"],
    ["trim", "{file}", "-o", "{out}", "--before=-5s"],
    ["trim", "{file}", "-o", "{out}", "--after", "+2m", "--before=-30s"],
    ["trim", "{file}", "-o", "{out}", "--after", "+0s"],
    ["trim", "{file}", "-o", "{out}", "--after", "1989-12-31T00:00:00Z"],
    ["trim", "{file}", "-o", "{out}", "--after", "zzz"],
    ["trim", "{file}", "-o", "{out}"],
    ["doctor", "{file}"],
    ["doctor", "{file}", "--json"],
    ["doctor", "{file}", "--platform", "strava"],
    ["doctor", "{file}", "--platform", "strict-spec", "--json"],
    ["reveal", "{file}"],
    ["reveal", "{file}", "--json"],
    ["scrub", "{file}", "-o", "{out}"],
    ["scrub", "{file}", "-o", "{out}", "--gps-radius", "500"],
    ["scrub", "{file}", "-o", "{out}", "--drop-all-gps"],
    ["scrub", "{file}", "-o", "{out}", "--keep-identity", "--keep-serials", "--keep-body-metrics"],
    [
        "scrub",
        "{file}",
        "-o",
