...
| **M2.8** ◐ | in progress | File surgery — the write verbs users actually ask for: F26 `edit` (metadata) ✅ 0.5.0; F27 `trim` (crop + rebuild) ✅ 0.6.0; F28 `reveal`/`scrub` (privacy) ✅ 0.7.0; F29 convert, F30 merge queued |
